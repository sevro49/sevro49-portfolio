        ...
        <div className="flex flex-col md:flex-row  items-center justify-center ">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-4 flex flex-col gap-2 items-center">
              <p className="text-yellow-400 text-center text-sm md:text-base animate__animated animate__flash animate__slower animate__infinite">Reach out to me for web projects or collaboration inquiries!</p>
              <div className="flex flex-col md:flex-row items-center justify-center gap-3">
                ...
                <a href="mailto:dr.emreguler@hotmail.com.tr">
                  <Button className="bg-yellow-400 hover:bg-yellow-500 flex items-center gap-2">
                    <Icon icon="material-symbols:mail-outline" className="text-3xl text-zinc-800 group-hover:bg-yellow-400 group-hover:text-zinc-800 rounded-md transition-all duration-300"/>
                    <span className="text-zinc-800 font-semibold text-sm md:text-base">dr.emreguler@hotmail.com.tr</span>
                  </Button>
                </a>
